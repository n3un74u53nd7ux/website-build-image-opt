...
if (resp['state']['open']) {
   jQuery('#spacestatus').html('<span style="color:white; background-color:#5cb85c; padding:3px 5px 3px 5px; border-radius:4px; display:inline-block;">Das Eigenbaukombinat ist <span id="howlong"></span> offen,   <a href="/wiedereroeffnung/">Anmelde-, Verhaltens- und Hygieneregeln beachten</a>!</span>');
